...
FRAMEWORK_BUILD_PATH="build/Loopy.embeddedframework"
...
cp Loopy/*.h $FRAMEWORK_DIR/Headers/
rsync -avzlH Loopy/Resources/ $FRAMEWORK_BUILD_PATH/Resources
